...
<body>
    ...
    $google_faq = [
        ...
        'answer' => '<p>La recente <a href="#">decisione della Corte di giustizia dell\'Unione europea</a> ha profonde conseguenze per i motori di ricerca in Europa. 
                        ...
                        Riceverai una answer automatica che conferma la ricezione della tua richiesta. 
        ...
        'answer' => '<p>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</p>
                        ...
                        <li>
                            ...
                            <ul>
                            <li><p>a. Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell\'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</p></li>
