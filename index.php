...
<body>
    ...
    $google_faq = [
        ...
        'answare' => '<p>La recente <a href="#">decisione della Corte di giustizia dell\'Unione europea</a> ha profonde conseguenze per i motori di ricerca in Europa. 
                        ...
                        Riceverai una answare automatica che conferma la ricezione della tua richiesta. 
        ...
        'answare' => '<p>Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. 
        ...
        'answare' => '<p>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</p>
        ...
        'answare' => '<p>I risultati di ricerca di Google rispecchiano i contenuti pubblicamente disponibili sul Web. 
